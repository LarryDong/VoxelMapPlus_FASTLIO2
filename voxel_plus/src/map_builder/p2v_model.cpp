...
void P2VModel::predict(const vector<Eigen::Vector3d>& points, const Eigen::Vector3d& query, Eigen::Vector3d& p2v_pred, double& weight){
    cout << "Predict..." << endl;
    cout <<"Input query-point: " << query.transpose() << endl;
    cout <<" TODO: " << endl;
